...
namespace weCare.Core.Utils
{
    ...
    public class BarCode128
    {
        ...
        /// 绘制Code128码到图片
        /// </summary>
        public System.Drawing.Image EncodeBarcode(string code, int width, int height, bool showText)
        {
        ...
        {
            System.Drawing.Image image = EncodeBarcode(code, width, height, showText);
