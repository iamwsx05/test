...
namespace test
{
    ...
    {
        public frmMeals(List<EntityEmployee> _lstEmployee)
        {
            InitializeComponent();
        ...
        List<EntityMealRecords> lstGeneralMeal { get; set; }
        ...
        void Init()
        {
            ...
            //this.lblName.Text = employee.emp_fname;
        ...
        void iChk_CheckedChanged(object sender, EventArgs e)
        {
            ...
            EntityEmployee employee = this.gvEmployee.GetRow(this.gvData.FocusedRowHandle) as EntityEmployee;
            if (employee != null)
            {
                this.lblName.Text = employee.emp_fname;
                GeneralMeals(employee);
            }
        ...
        void GeneralMeals(EntityEmployee employee)
        {
            if (employee == null)
                return;
            lstGeneralMeal = new List<EntityMealRecords>();
            ...
            this.gcData.DataSource = lstGeneralMeal;
        ...
        private void gvEmployee_RowCellClick(object sender, DevExpress.XtraGrid.Views.Grid.RowCellClickEventArgs e)
        {
            ...
            EntityEmployee employee = this.gvEmployee.GetRow(e.RowHandle) as EntityEmployee;
            if (employee != null)
            {
                this.lblName.Text = employee.emp_fname;
                GeneralMeals(employee);
